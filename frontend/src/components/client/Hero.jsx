      ...
      <section className="min-h-[130vh] flex flex-col md:flex-row items-center justify-between p-10 bg-gradient-to-r from-gray-100 to-[#DDFEF1] pt-20 lg:pt:0">
        ...
        <div className="w-full md:w-1/2 mt-8 md:mt-10">
          ...
          <div className="flex justify-center space-x-4 mt-10">
            <button
              onClick={() => handleTabSwitch("flight")}
              className={`py-2 px-4 font-semibold transition ${
                activeTab === "flight" ? "bg-white text-blue-600" : "text-black"
              } rounded-md`}
            >
              Flight
            </button>
            <button
              ...
              className={`py-2 px-4 font-semibold transition ${
                activeTab === "hotel" ? "bg-white text-blue-600" : "text-black"
              } rounded-md`}
            >
              Hotel
            </button>
            <button
              onClick={() => handleTabSwitch("both")}
              className={`py-2 px-4 font-semibold transition ${
                activeTab === "both" ? "bg-white text-blue-600" : "text-black"
              } rounded-md`}
            >
              Both
            </button>
          ...
          {/* Flight Tab Content */}
          {activeTab === "flight" && (
            <div className="mt-6 bg-white p-6 rounded-md shadow-lg transition-all duration-500">
              ...
              <form className="space-y-4">
                ...
                <button className="w-full bg-[#32B57A] text-white text-xl p-3 rounded-md  transition">
                  Buy Dummy Ticket
                </button>
              </form>
            </div>
          ...
          {/* Both (Flight + Hotel) Tab Content */}
          {activeTab === "both" && (
            <div className="mt-6 bg-white p-6 rounded-md shadow-lg transition-all duration-500">
              <h2 className="text-xl font-bold mb-4">Book Flight + Hotel</h2>
              <form className="space-y-4">
                {/* Flight Section */}
                <div className="space-y-4">
